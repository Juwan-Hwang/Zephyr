...
The latest release branch (`main`) is actively supported with security updates.

## Security Architecture

Zephyr implements a defense-in-depth security architecture. For details, see:
- [Security Wiki](https://github.com/Juwan-Hwang/Zephyr/wiki/Security)
