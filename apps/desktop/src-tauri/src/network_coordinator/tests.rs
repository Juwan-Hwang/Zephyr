...
use super::detector::{invalidate_ssid_cache, is_cache_empty};
...
fn test_invalidate_cache() {
    ...
    // Verify the cache was actually invalidated.
    assert!(is_cache_empty(), "Cache must be empty after invalidation");
}
