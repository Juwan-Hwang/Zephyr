                            ...
                            if orig_mode != "global" {
                                    ...
                                    get_mihomo_active_node_and_global_now(app).await
                                {
                                    ...
                                    if mode_switched {
                                        ...
                                        // Keep restore_guard.orig_mode armed: if the PATCH request succeeded
                                        // on the server side before transport disconnection/timeout,
                                        // drop / normal restoration will conservatively restore the original mode.
                                    }
