...
/// and the extension is auto-detected from the downloaded content.
/// If the download fails, the override is still created with a default template
/// and the user can retry via `override_refresh_remote`.
#[tauri::command]
