...
async function hasCoreUpdate() {
  try {
    ...
    return normalizeVersion(latest.version) !== normalizeVersion(currentVersion);
  } catch (e) {
...
async function hasClientUpdate() {
  try {
    ...
    return normalizeVersion(info.version) !== normalizeVersion(currentVersion);
  } catch (e) {
