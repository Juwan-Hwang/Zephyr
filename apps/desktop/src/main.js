...
async function initApp() {
  ...
  // 8b. Initialize console home page (if enabled)
  try {
    initConsoleHome();
    // Page visibility was already set in step 5 — no need to simulate a nav click.
    // If console mode is enabled, activateConsole() will be called by the nav system
    // when the user clicks the home button (which redirects to console).
    // We call activateConsole() directly here since the page is already visible.
