...
function updateSortIndicators() {
    ...
    for (const cell of header.querySelectorAll('.sortable')) {
        ...
        const originalColors = {
            ...
            dlSpeed: 'color-mix(in srgb, #a855f7 70%, transparent)',
            dlTotal: 'color-mix(in srgb, #a855f7 50%, transparent)',
            ulSpeed: 'color-mix(in srgb, #3b82f6 70%, transparent)',
            ulTotal: 'color-mix(in srgb, #3b82f6 50%, transparent)',
        };
