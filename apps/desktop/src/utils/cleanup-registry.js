...
export function runCleanup() {
    ...
    //
    // Use a safe scheduler — queueMicrotask may be missing on older
    // WebViews, and during beforeunload microtask execution can be
    // unreliable. Fall back to Promise.resolve().then().
