...
describe('clipboard utils - pasteToElement', () => {
    ...
    describe('renderPasteButtonHtml', () => {
        ...
        it('supports custom i18nKey and null i18nKey to omit data-i18n attributes', () => {
            const customKeyHtml = renderPasteButtonHtml('custom-btn', 'Custom Paste', false, 'customPasteKey');
            expect(customKeyHtml).toContain('data-i18n-title="customPasteKey"');
            expect(customKeyHtml).toContain('data-i18n-aria-label="customPasteKey"');
