        ...
        testBtn.onclick = async () => {
            ...
            try {
                ...
                try {
                    ...
                    // Safety net: clear stuck pending state and re-render to
                    // sync UI with test results. Only re-render when there
                    // were actually stuck cards or hide_timeout_nodes is on.
                    const container = document.getElementById('proxies-list');
                    ...
                    proxyLogger.warn('post-latency cleanup failed', e);
                }
            }
        };
    }
