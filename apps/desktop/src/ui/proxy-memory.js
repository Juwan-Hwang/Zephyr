...
export async function restoreProxySelection(profileName) {
    try {
        ...
        // group name to be saved as the node).  Skip restoration early to
        // avoid waiting for provider downloads and jumping to GLOBAL.  This
        // check is precise: a valid group-as-node selection always has
