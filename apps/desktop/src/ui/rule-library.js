...
contentArea.querySelector('#rl-import-paste-btn')?.addEventListener('click', () => {
    ...
    if (textarea) pasteToElement(textarea, true, () => showNotification(translations[currentLang]?.pasteFailed || translations.en.pasteFailed, 'warning'));
});
contentArea.querySelector('#rl-import-url-paste-btn')?.addEventListener('click', () => {
    ...
    if (urlInput) pasteToElement(urlInput, true, () => showNotification(translations[currentLang]?.pasteFailed || translations.en.pasteFailed, 'warning'));
});
