    ...
    return `
        <div class="flex flex-col overflow-hidden" style="max-height: calc(65vh - 6rem)">
            ...
            <div id="rl-editor-text" class="hidden flex-1 min-h-0 overflow-y-auto custom-scrollbar mt-4">
                <textarea id="rl-editor-textarea" class="form-control form-control-mono hidden w-full min-h-full rounded-[var(--zephyr-radius-overlay)] p-4 text-xs resize-none" spellcheck="false"></textarea>
