...
export const SVG_ICONS = {
    ...
    collapseArrow: '<svg class="w-3 h-3 text-[var(--text-muted)] transition-transform ease-[cubic-bezier(0.25,1,0.5,1)] collapse-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>',
    collapseArrowSmall: '<svg class="w-2.5 h-2.5 text-[var(--text-muted)] transition-transform ease-[cubic-bezier(0.25,1,0.5,1)] collapse-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>',
};
