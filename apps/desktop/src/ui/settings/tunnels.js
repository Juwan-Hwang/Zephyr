            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="input-paste-wrapper">
                        ...
                        ${renderPasteButtonHtml('tunnel-address-paste-btn', `${t.paste || 'Paste'} (${t.tunnelNetwork || 'Listen Network'})`, false, null)}
                    </div>
                </div>
                <div>
                    ...
                    <div class="input-paste-wrapper">
                        ...
                        ${renderPasteButtonHtml('tunnel-target-paste-btn', `${t.paste || 'Paste'} (${t.tunnelTarget || 'Target Address'})`, false, null)}
                    </div>
                </div>
...
contentArea.querySelector('#tunnel-address-paste-btn')?.addEventListener('click', (e) => {
    e.preventDefault();
    if (addressInput) {
        pasteWithFeedback(addressInput, showNotification, translations, appStore.get('currentLang') || 'en');
    }
});
contentArea.querySelector('#tunnel-target-paste-btn')?.addEventListener('click', (e) => {
    e.preventDefault();
    if (targetInput) {
        pasteWithFeedback(targetInput, showNotification, translations, appStore.get('currentLang') || 'en');
    }
});
