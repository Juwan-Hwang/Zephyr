...
export function initThemeSettings({
    ...
    const effectiveThemeMode = savedThemeMode && themeModeMap.includes(savedThemeMode) ? savedThemeMode : 'auto';
    ...
    const opacityVal = savedOpacity != null ? String(savedOpacity) : '100';
