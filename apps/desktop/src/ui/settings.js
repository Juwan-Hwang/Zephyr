...
export async function initSettings() {
        ...
        restoreDefaultsBtn.onclick = async () => {
            ...
            try {
                ...
                if (nodeScrollToggle) {
                    ...
                    // Clear proxy container and re-render to apply CSS class change
    ...
    const loadSettingsFromCore = async () => {
        try {
            ...
            if (portDisplay) {
                // Check all ports in priority order: mixed > http > socks
                const settingsPort = [userSettings.mixed_port, userSettings.http_port, userSettings.socks_port]
