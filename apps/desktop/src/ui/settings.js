    ...
    if (checkUpdateBtn) {
        checkUpdateBtn.onclick = async () => {
            ...
            try {
                ...
                const coreHasUpdate = latest && latest.version && isRemoteNewer(normalizeVersion(latest.version), normalizeVersion(currentCoreVersion));
                const clientHasUpdate = clientInfo && clientInfo.version && isRemoteNewer(normalizeVersion(clientInfo.version), normalizeVersion(currentAppVersion));
