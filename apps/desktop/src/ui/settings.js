    ...
    if (restoreDefaultsBtn) {
        restoreDefaultsBtn.onclick = async () => {
            ...
            try {
                ...
                settings.theme = 'zinc';
                applyTheme('zinc');
                document.querySelectorAll('.theme-btn').forEach(b => b.classList.remove('ring-2', 'ring-offset-2', 'ring-offset-[var(--zephyr-bg-primary)]'));
                const defaultThemeBtn = document.querySelector('.theme-btn[data-theme="zinc"]');
                if (defaultThemeBtn) {
                    defaultThemeBtn.classList.add('ring-2', 'ring-offset-2', 'ring-offset-[var(--zephyr-bg-primary)]', 'ring-zinc-500');
                }
