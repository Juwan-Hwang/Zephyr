...
function initLogSettingsModal() {
    ...
    settingsBtn?.addEventListener('click', () => {
        ...
        const retentionDays = Number.isFinite(rawRetention) && rawRetention >= 1 && rawRetention <= 30 ? rawRetention : 3;
        const rawMaxFileMb = Number(appStore.get('logMaxFileMb'));
        const maxFileMb = Number.isFinite(rawMaxFileMb) && rawMaxFileMb >= 1 && rawMaxFileMb <= 500 ? rawMaxFileMb : 50;
