...
let isActive = false;
/** @type {number | null} Timestamp (ms) of the last traffic sample, for integrating rates into totals. */
let lastTrafficTsMs = null;
...
function renderNumbers() {
    ...
    // KPI: Session traffic (accumulated since app launch)
...
<div class="dz-content custom-scrollbar">
    ...
    <div class="dz-kpis">
        ...
        <div class="glass-card dz-kpi">
            <div class="dz-kpi-top">
                <span class="dz-kpi-label" data-i18n="consoleSessionTraffic">本期流量</span>
    ...
    <div class="dz-grid-main">
        ...
        <div class="dz-side">
            <div class="dz-node-wrap">
                ...
                <div class="dz-node-picker dz-hidden" id="dz-node-picker" role="listbox">
...
hostCopyEl?.addEventListener('click', () => {
    ...
    _trafficUnsub = Bus.on(Events.TRAFFIC_UPDATE, (/** @type {any} */ data) => {
        ...
        const now = Date.now();
        if (lastTrafficTsMs) {
            const dtSec = Math.min(5, (now - lastTrafficTsMs) / 1000);
...
export function deactivateConsole() {
    ...
    lastTrafficTsMs = null; // reset so totals don't spike on re-activate
}
...
async function fetchCoreUptime() {
    try {
        ...
        if (typeof uptime === 'number') {
            ...
            // Core not running — reset so tickUptime stops incrementing
            coreUptimeSec = null;
        }
        renderUptime();
    } catch {
