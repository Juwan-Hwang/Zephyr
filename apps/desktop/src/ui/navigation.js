...
export function initNavigation(callbacks = {}) {
    ...
    function fireLeaveCallback(targetPage) {
        ...
        if (leaveKey && targetPage !== currentPage && callbacks[leaveKey]) {
            callbacks[leaveKey]();
        }
    }
    ...
    function fireEnterCallback(targetPage) {
        ...
        if (enterKey && callbacks[enterKey]) {
            callbacks[enterKey]();
        }
    }
    ...
    function navigateToInternal(targetPage) {
        ...
        fireLeaveCallback(targetPage);
        updateNavStyling(targetPage);
        switchPage(targetPage);
        currentPage = targetPage;
        fireEnterCallback(targetPage);
    }
