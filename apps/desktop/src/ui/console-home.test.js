...
describe('Console Dashboard Width Threshold and Notification', () => {
    ...
    describe('Settings home_page_mode switch behavior', () => {
        it('triggers width notification when mode is switched to console in a narrow window', async () => {
        ...
        it('does NOT trigger width notification when mode is switched to console in a wide window', async () => {
        ...
        it('does NOT trigger width notification when mode is switched to minimal', async () => {
            const { appStore } = await import('./state.js');
            const { Bus, Events } = await import('./events.js');
            const { invoke } = await import('../api.js');
            ...
            const mode = 'minimal';
            const previous = appStore.get('homePageMode') || 'console';
