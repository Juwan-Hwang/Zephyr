...
export const translations = {
    en: {
        ...
        mixedPortHint: "HTTP & SOCKS5 combined port",
        socksPort: "SOCKS5 Port",
        socksPortHint: "Standalone SOCKS5 proxy port",
        redirPort: "Redir Port",
        redirPortHint: "Transparent proxy port (Linux)",
        tproxyPort: "TProxy Port",
        tproxyPortHint: "TProxy port (Linux)",
    ...
    zh: {
        ...
        mixedPort: "混合端口",
        mixedPortHint: "HTTP 与 SOCKS5 混合代理端口",
        socksPort: "SOCKS5 端口",
        socksPortHint: "独立 SOCKS5 代理端口",
        redirPort: "透明代理端口",
        redirPortHint: "透明代理端口（Linux）",
        tproxyPort: "TProxy 端口",
        tproxyPortHint: "TProxy 端口（Linux）",
        portRangeError: "端口范围应为 1-65535",
