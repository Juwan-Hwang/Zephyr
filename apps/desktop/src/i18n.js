...
export const translations = {
    en: {
        ...
        networkOptimModalDesc: "This will modify system TCP parameters to improve network performance, especially for high-latency connections (RTT > 25ms). These changes require administrator privileges.",
        ...
        networkOptimModalWarning: "Note: These modifications require administrator/root privileges. On Linux, changes are persisted to /etc/sysctl.d/ and survive reboot. On macOS, changes are lost after reboot. On Windows, changes are system-level and persistent.",
    ...
    zh: {
        ...
        networkOptimModalDesc: "此操作将修改系统 TCP 参数以提升网络性能，尤其适用于高延迟连接（RTT > 25ms）。这些修改需要管理员权限。",
        ...
        networkOptimModalWarning: "注意：这些修改需要管理员/root 权限。Linux 上修改会持久化到 /etc/sysctl.d/ 并在重启后保留。macOS 上修改在重启后失效。Windows 上修改为系统级且持久化。",
