...
- **Supply Chain Hardening** — All GitHub Actions pinned to commit SHA, `persist-credentials: false` on checkout, `pnpm overrides` for transitive vulnerability fixes (nanoid/brace-expansion/ws/undici/tar), `engines.node >= 20.18.1`
