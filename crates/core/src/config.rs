...
pub use subscription::{
    ...
    is_destination_in_no_proxy, is_host_in_no_proxy, is_literal_private_host, is_private_host,
    is_private_ip, matches_no_proxy_rules, matches_no_proxy_rules_with_port,
    ...
    validate_ambient_proxy_url_for_scheme, validate_public_host_addrs, validate_subscription_name,
    validate_subscription_url_basic, validate_subscription_url_with_ip, BatchUpdateItem,
    BatchUpdateResult, PublicHostAddrError, MAX_RESPONSE_SIZE,
};
pub use types::{
