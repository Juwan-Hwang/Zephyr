...
if [ ! -f "$UPSTREAM_PLUGIN" ]; then
    ...
    if ! curl --proto =https -sfL --retry 3 --retry-delay 2 "https://raw.githubusercontent.com/linuxdeploy/linuxdeploy-plugin-gtk/3b67a1d1c1b0c8268f57f2bce40fe2d33d409cea/linuxdeploy-plugin-gtk.sh" \
        -o "$TMPFILE"; then
