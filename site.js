  ...
  const i18n = {
    ...
    dict: {
      zh: {
        ...
        'install.mac.tap.title': 'Zephyr 官方 Tap',
        'install.mac.tap.sub': '官方第一手快速通道',
        'install.mac.tap.desc': '作者官方维护的 Homebrew 源，发版即时极速推送。',
        'install.linux.aur.sub': 'Arch Linux 官方用户软件库',
        'install.linux.aur.desc': '通过 yay 或 paru 一键安装并托管系统依赖与升级。',
        'install.linux.ppa.sub': 'Launchpad 官方 PPA 源',
        'install.linux.ppa.desc': '完全兼容 apt 包管理生态，经个人硬件 GPG 严格校验。',
        'install.linux.copr.sub': 'Fedora 官方云构建源',
        'install.linux.copr.desc': '规范 RPM 打包，原生支持 dnf / dnf5 / zypper 自动升级。',
        'install.linux.snap.sub': 'Ubuntu 官方商店收录',
        ...
        'dropdown.group.linux': 'Linux 发行版',
      ...
      en: {
        ...
        'install.win.scoop.title': 'Scoop Package Manager',
        ...
        'install.win.choco.title': 'Chocolatey Community Repository',
        ...
        'install.mac.tap.title': 'Zephyr Official Tap',
        ...
        'install.linux.aur.sub': 'Arch User Repository',
        'install.linux.aur.desc': 'One-click install and update via yay or paru with full dependency management.',
        'install.linux.ppa.sub': 'Launchpad Official PPA',
        'install.linux.ppa.desc': 'Native apt ecosystem integration with hardware GPG signature verification.',
        'install.linux.copr.sub': 'Fedora Official Cloud Build',
        'install.linux.copr.desc': 'Standard RPM packaging with native dnf / dnf5 / zypper auto-updates.',
        'install.linux.snap.sub': 'Canonical Snap Store',
        ...
        'dropdown.group.windows': 'Windows',
        'dropdown.group.macos': 'macOS',
        'dropdown.group.linux': 'Linux Distributions',
