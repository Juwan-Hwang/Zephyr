...
class ObjectLiteralParser {
    ...
    parseUnicodeEscape() {
        ...
        if (content[this.pos + 2] === '{') {
            ...
            this.pos = end + 1;
            // Code points in the surrogate range (0xD800–0xDFFF) are valid
            // in \u{...} escapes but rejected by fromCodePoint. Use
            // fromCharCode for BMP code units (including lone surrogates),
            // fromCodePoint for astral-plane code points.
