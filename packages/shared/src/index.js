...
export const CONFIG_FILES = Object.freeze({
    ...
    UPDATE_LAST_CONFIG: "update_last_config",
...
export const NETWORK_OPTIM = Object.freeze({
    APPLY: "apply_network_optimizations",
    REVERT: "revert_network_optimizations",
    CHECK_STATUS: "check_network_optimizations_status",
});
